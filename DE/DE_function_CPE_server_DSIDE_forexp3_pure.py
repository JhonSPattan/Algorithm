...
class DSIDE_Algorithm():
    ...
    def optimize(self,filename:str,cr:float = 0.8,sf:float = 0.2):
        ...
        file_path = self.main_path+'/Graphpure/'+self.functiontype+'/value/'+self.functionname+'_'+self.filename+'.csv'
        with open(file_path,'w',encoding='UTF8',newline='') as f:
            writer = csv.writer(f)
        ...
        file_path = self.main_path+'/Scaling_Graphpure/'+self.functiontype+'/value/'+self.functionname+'_'+self.filename+'_scalingvalue'+'.csv'
        with open(file_path,'w',encoding='UTF8',newline='') as f:
            writer = csv.writer(f)
            writer.writerow(['Max','Min','Mean'])
            writer.writerows(scalingfactorAveragevalue)

        file_path = self.main_path+'/Scaling_Graphpure/'+self.functiontype+'/value/'+self.functionname+'_'+self.filename+'_crossovervalue'+'.csv'
        with open(file_path,'w',encoding='UTF8',newline='') as f:
            writer = csv.writer(f)
            writer.writerow(['Max','Min','Mean'])
            writer.writerows(crossoverAveragevalue)

        file_path = self.main_path+'/Scaling_Graphpure/'+self.functiontype+'/value/'+self.functionname+'_'+self.filename+'_dimensionvalue'+'.csv'
        with open(file_path,'w',encoding='UTF8',newline='') as f:
            writer = csv.writer(f)
            writer.writerow(['Max','Min','Mean'])
        ...
        #print(acceptAverage)
        file_path = self.main_path+'/Scaling_Graphpure/'+self.functiontype+'/value/'+self.functionname+'_'+self.filename+'_acceptvalue'+'.csv'
        with open(file_path,'w',encoding='UTF8',newline='') as f:
            writer = csv.writer(f)
            writer.writerow(['Accept'])
            for i in range(replace):
