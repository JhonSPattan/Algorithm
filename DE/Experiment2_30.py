...
DSIDE_obj.optimize(filename='DSIDE_2-2line1'+strategy_name,cr=0.4,sf=0.3)
DSIDE_obj.optimize(filename='DSIDE_2-2line2'+strategy_name,cr=0.6,sf=0.3)
DSIDE_obj.optimize(filename='DSIDE_2-2line3'+strategy_name,cr=0.8,sf=0.3)

DSIDE_obj = DSIDE_Algorithm(functionname='Sphere',functioneveluate=Sphere_fun,strategy=strategy1,cr_fix=False,control=True)
DSIDE_obj.optimize(filename = 'DSIDE_2-2line4'+strategy_name,sf=0.3,cr_reversed=True)
DSIDE_obj.optimize(filename='DSIDE_2-2line5'+strategy_name,sf=0.3)

DSIDE_obj = DSIDE_Algorithm(functionname='Sphere',functioneveluate=Sphere_fun,strategy=strategy1,cr_fix=False)
DSIDE_obj.optimize(filename='DSIDE_2-2line6'+strategy_name,sf=0.3)
