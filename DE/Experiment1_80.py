...
DSIDE_obj.optimize(filename='DSIDE_1-3line1'+strategy_name,cr=0.8,sf=0.2)
DSIDE_obj.optimize(filename='DSIDE_1-3line2'+strategy_name,cr=0.8,sf=0.3)
DSIDE_obj.optimize(filename='DSIDE_1-3line3'+strategy_name,cr=0.8,sf=0.5)

DSIDE_obj = DSIDE_Algorithm(functionname='Sphere',functioneveluate=Sphere_fun,strategy=strategy1,sf_fix=False,control=True)
DSIDE_obj.optimize(filename = 'DSIDE_1-3line4'+strategy_name,cr=0.8,sf_reversed=True)
DSIDE_obj.optimize(filename='DSIDE_1-3line5'+strategy_name,cr=0.8)

DSIDE_obj = DSIDE_Algorithm(functionname='Sphere',functioneveluate=Sphere_fun,strategy=strategy1,sf_fix=False)
DSIDE_obj.optimize(filename='DSIDE_1-3line6'+strategy_name,cr=0.8)
