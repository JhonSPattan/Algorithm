...
# function
def build_trial_nearest(r_vector1:np.array,r_vector2:np.array,target:np.array,generation:float,crossover_rate:float)->np.array:
    cr_rate = crossover_rate  #0.8-(0.3*(generation/round))       # 0.8 -> 0.5
    scale_factor = 0.2+(0.3*(generation/round))  # 0.2 -> 0.5
...
def build_trial_best(best_vector:np.array,r_vector1:np.array,target:np.array,generation:float,crossover_rate:float)-> np.array:
    cr_rate = crossover_rate  #0.8-(0.3*(generation/round))       # 0.8 -> 0.5
    scale_factor = 0.2+(0.3*(generation/round))  # 0.2 -> 0.5
    dummy_vector = np.random.uniform(low=0,high=1,size=dimension)
    weight = 0.8*(cr_rate)
...
for cr in [0.8, 0.6, 0.4]:
    ...
    for k in range(replace):
        ...
        for i in tqdm(range(round),desc="Function "+functionname+"_"+str(dimension)+"di_"+str(round)+"_"+str(populationsize)+"_run_"+str(k+1)):
            ...
            for j in range(populationsize):
                if value[j] == 0:
                    ...
                    vectorrand = np.delete(vectorrand,del_index)
                    near_vector = population[index]
                    rand_vector = population[vectorrand[0]]
                    trial_vector = build_trial_nearest(r_vector1=near_vector,r_vector2=rand_vector,target=population[j],generation=(i+1),crossover_rate=crossover_rate)
                else:
                    ...
                    if ratio < 0.5:
                        ...
                        rand_vector = population[vectorrand[0]]
                        trial_vector = build_trial_best(best_vector=minimized_vector,r_vector1=rand_vector,target=population[j],generation=(i+1),crossover_rate=crossover_rate)
                    else:
                        index = distance_index(population[j],population)
                        vectorrand = np.random.permutation(populationsize)
                        del_index = np.where(vectorrand==index)[0][0]
        ...
        file_path = '/home/pythonrunnew/Algorithm/raw_reault/'+functionname+'_result/DE2N_Cr_'+str(crossover_rate)+'_'+functionname+'_'+str(dimension)+'_run_'+str(k+1)+'_population_'+str(populationsize)+'_round_'+str(round)+'_.csv'
        #file_path = 'C:/Users/patip/Documents/Python/Algorithm/raw_reault/'+functionname+'_result/DE2N_Cr_'+str(crossover_rate)+'_'+functionname+'_'+str(dimension)+'_run_'+str(k+1)+'_population_'+str(populationsize)+'.csv'
        with open(file_path,'w',encoding='UTF8',newline='') as f:
            writer = csv.writer(f)
            writer.writerow(['Solution','round','time'])
            writer.writerows(minimized_value_keep)
        
        file_path = '/home/pythonrunnew/Algorithm/analysis_result/'+functionname+'_result/DE2N_Cr_'+str(crossover_rate)+'_'+functionname+'_analysis_'+str(dimension)+'_run_'+str(k+1)+'_population_'+str(populationsize)+'_round_'+str(round)+'_.csv'
        #file_path = 'C:/Users/patip/Documents/Python/Algorithm/analysis_result/'+functionname+'_result/DE2N_Cr_'+str(crossover_rate)+'_'+functionname+'_analysis_'+str(dimension)+'_run_'+str(k+1)+'_population_'+str(populationsize)+'.csv'
        with open(file_path,'w',encoding='UTF8',newline='') as f:
            writer = csv.writer(f)
            writer.writerow(['max','min','mean'])
            writer.writerows(value_analysis)
    
    file_path = '/home/pythonrunnew/Algorithm/time/DE2N_Cr_'+str(crossover_rate)+'_'+functionname+'_timeperround_'+str(dimension)+'_population_'+str(populationsize)+'.csv'
    #file_path = 'C:/Users/patip/Documents/Python/Algorithm/time/DE2N_Cr_'+str(crossover_rate)+'_'+functionname+'_timeperround_'+str(dimension)+'_population_'+str(populationsize)+'.csv'
    with open(file_path,'w',encoding='UTF8',newline='') as f:
            writer = csv.writer(f)
    ...
    for k in range(replace):
        path = '/home/pythonrunnew/Algorithm/raw_reault/'+functionname+'_result/DE2N_Cr_'+str(crossover_rate)+'_'+functionname+'_'+str(dimension)+'_run_'+str(k+1)+'_population_'+str(populationsize)+'_round_'+str(round)+'_.csv'
        #path = 'C:/Users/patip/Documents/Python/Algorithm/raw_reault/'+functionname+'_result/DE2N_Cr_'+str(crossover_rate)+'_'+functionname+'_'+str(dimension)+'_run_'+str(k+1)+'_population_'+str(populationsize)+'.csv'
    ...
    #'/home/pythonrunnew/Algorithm/Graph/MultimodalFuntion/value/DE2N_Cr_'+str(crossover_rate)+'_Scaffer2_30_population_100.csv'
    file_path = '/home/pythonrunnew/Algorithm/Graph/'+function_type+'/value/DE2N_Cr_'+str(crossover_rate)+'_'+functionname+'_'+str(dimension)+'_population_'+str(populationsize)+'_round_'+str(round)+'_.csv'
    #file_path = 'C:/Users/patip/Documents/Python/Algorithm/Graph/'+function_type+'/value/DE2N_Cr_'+str(crossover_rate)+'_'+functionname+'_'+str(dimension)+'_population_'+str(populationsize)+'.csv'
    with open(file_path,'w',encoding='UTF8',newline='') as f:
        writer = csv.writer(f)
        writer.writerow(['Average'])
        writer.writerows(solution_average)

    print('Minimized Solution Max: ',str(max(minsolution)))
    ...
    file_path = '/home/pythonrunnew/Algorithm/Graph/'+function_type+'/value/DE2N_Cr_'+str(crossover_rate)+'_description_'+functionname+'_'+str(dimension)+'_population_'+str(populationsize)+'_round_'+str(round)+'_.txt'
    ...
    for i in range(replace):
        path = '/home/pythonrunnew/Algorithm/analysis_result/'+functionname+'_result/DE2N_Cr_'+str(crossover_rate)+'_'+functionname+'_analysis_'+str(dimension)+'_run_'+str(i+1)+'_population_'+str(populationsize)+'_round_'+str(round)+'_.csv'
        #path = 'C:/Users/patip/Documents/Python/Algorithm/analysis_result/'+functionname+'_result/DE2N_Cr_'+str(crossover_rate)+'_'+functionname+'_analysis_'+str(dimension)+'_run_'+str(i+1)+'_population_'+str(populationsize)+'.csv'
        print(path)
        my_sol = pd.read_csv(path,nrows=row_data)
    ...
    file_path = '/home/pythonrunnew/Algorithm/Graph/'+function_type+'/analysis/DE2N_Cr_'+str(crossover_rate)+'_'+functionname+'_analysis_'+str(dimension)+'_population_'+str(populationsize)+'_round_'+str(round)+'_.csv'
    #file_path = 'C:/Users/patip/Documents/Python/Algorithm/Graph/'+function_type+'/analysis/DE2N_Cr_'+str(crossover_rate)+'_'+functionname+'_analysis_'+str(dimension)+'_population_'+str(populationsize)+'.csv'
    with open(file_path,'w',encoding='UTF8',newline='') as f:
        writer = csv.writer(f)
        writer.writerow(['max','min','mean'])
...
for cr in [0.8, 0.6, 0.4]:
    ...
    # '/home/pythonrunnew/Algorithm/Graph/MultimodalFuntion/value/DE2N_Cr_'+str(crossover_rate)+'_Scaffer2_30_population_100.csv'
    file_path = '/home/pythonrunnew/Algorithm/Graph/'+function_type+'/value/DE2N_Cr_'+str(crossover_rate)+'_'+functionname+'_'+str(dimension)+'_population_'+str(populationsize)+'_round_'+str(round)+'_.csv'
    #ile_path = 'C:/Users/patip/Documents/Python/Algorithm/Graph/'+function_type+'/value/DE2N_Cr_'+str(crossover_rate)+'_'+functionname+'_'+str(dimension)+'_population_'+str(populationsize)+'.csv'
    with open(file_path,'w',encoding='UTF8',newline='') as f:
        writer = csv.writer(f)
        writer.writerow(['Average'])
        writer.writerows(solution_average)
