...
def build_trial_nearest(r_vector1:np.array,r_vector2:np.array,target:np.array,generation)->np.array:
    cr_rate = (0.8-(0.8-0.5))*(generation/round)       # 0.8 -> 0.5
    scale_factor = 0.2 #(0.2-(0.5-0.2))*(generation/round)  # 0.2 -> 0.5
...
for k in range(replace):
    ...
    file_path = '/home/pythonrunnew/Algorithm/raw_reault/'+functionname+'_result/DE2N_F_fix_'+functionname+'_'+str(dimension)+'_run_'+str(k+1)+'_population_'+str(populationsize)+'_round_'+str(round)+'_.csv'
    #file_path = 'C:/Users/patip/Documents/Python/Algorithm/raw_reault/'+functionname+'_result/DE2N_F_fix_'+functionname+'_'+str(dimension)+'_run_'+str(k+1)+'_population_'+str(populationsize)+'.csv'
    ...
    file_path = '/home/pythonrunnew/Algorithm/analysis_result/'+functionname+'_result/DE2N_F_fix_'+functionname+'_analysis_'+str(dimension)+'_run_'+str(k+1)+'_population_'+str(populationsize)+'_round_'+str(round)+'_.csv'
    #file_path = 'C:/Users/patip/Documents/Python/Algorithm/analysis_result/'+functionname+'_result/DE2N_F_fix_'+functionname+'_analysis_'+str(dimension)+'_run_'+str(k+1)+'_population_'+str(populationsize)+'.csv'
    with open(file_path,'w',encoding='UTF8',newline='') as f:
        writer = csv.writer(f)
...
file_path = '/home/pythonrunnew/Algorithm/time/DE2N_F_fix_'+functionname+'_timeperround_'+str(dimension)+'_population_'+str(populationsize)+'.csv'
#file_path = 'C:/Users/patip/Documents/Python/Algorithm/time/DE2N_F_fix_'+functionname+'_timeperround_'+str(dimension)+'_population_'+str(populationsize)+'.csv'
with open(file_path,'w',encoding='UTF8',newline='') as f:
        writer = csv.writer(f)
...
for k in range(replace):
    path = '/home/pythonrunnew/Algorithm/raw_reault/'+functionname+'_result/DE2N_F_fix_'+functionname+'_'+str(dimension)+'_run_'+str(k+1)+'_population_'+str(populationsize)+'_round_'+str(round)+'_.csv'
    #path = 'C:/Users/patip/Documents/Python/Algorithm/raw_reault/'+functionname+'_result/DE2N_F_fix_'+functionname+'_'+str(dimension)+'_run_'+str(k+1)+'_population_'+str(populationsize)+'.csv'
...
# '/home/pythonrunnew/Algorithm/Graph/MultimodalFuntion/value/DE2N_F_fix_Scaffer2_30_population_100.csv'
file_path = '/home/pythonrunnew/Algorithm/Graph/'+function_type+'/value/DE2N_F_fix_'+functionname+'_'+str(dimension)+'_population_'+str(populationsize)+'_round_'+str(round)+'_.csv'
#file_path = 'C:/Users/patip/Documents/Python/Algorithm/Graph/'+function_type+'/value/DE2N_F_fix_'+functionname+'_'+str(dimension)+'_population_'+str(populationsize)+'.csv'
with open(file_path,'w',encoding='UTF8',newline='') as f:
    writer = csv.writer(f)
...
file_path = '/home/pythonrunnew/Algorithm/Graph/'+function_type+'/value/DE2N_F_fix_description_'+functionname+'_'+str(dimension)+'_population_'+str(populationsize)+'_round_'+str(round)+'_.txt'
#file_path = 'C:/Users/patip/Documents/Python/Algorithm/Graph/'+function_type+'/value/DE2N_F_fix_description_'+functionname+'_'+str(dimension)+'_population_'+str(populationsize)+'.txt'
f = open(file_path,'a')
...
for i in range(replace):
    path = '/home/pythonrunnew/Algorithm/analysis_result/'+functionname+'_result/DE2N_F_fix_'+functionname+'_analysis_'+str(dimension)+'_run_'+str(i+1)+'_population_'+str(populationsize)+'_round_'+str(round)+'_.csv'
    #path = 'C:/Users/patip/Documents/Python/Algorithm/analysis_result/'+functionname+'_result/DE2N_F_fix_'+functionname+'_analysis_'+str(dimension)+'_run_'+str(i+1)+'_population_'+str(populationsize)+'.csv'
    print(path)
    my_sol = pd.read_csv(path,nrows=row_data)
...
file_path = '/home/pythonrunnew/Algorithm/Graph/'+function_type+'/analysis/DE2N_F_fix_'+functionname+'_analysis_'+str(dimension)+'_population_'+str(populationsize)+'_round_'+str(round)+'_.csv'
#file_path = 'C:/Users/patip/Documents/Python/Algorithm/Graph/'+function_type+'/analysis/DE2N_F_fix_'+functionname+'_analysis_'+str(dimension)+'_population_'+str(populationsize)+'.csv'
with open(file_path,'w',encoding='UTF8',newline='') as f:
    writer = csv.writer(f)
    writer.writerow(['max','min','mean'])
